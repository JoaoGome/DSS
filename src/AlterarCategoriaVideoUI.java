...
public class AlterarCategoriaVideoUI extends javax.swing.JFrame {
    ...
    public AlterarCategoriaVideoUI() throws SQLException, ClassNotFoundException {
        initComponents();
    ...
    private void jButtonAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAlterarMouseClicked
        ...
        try {
            this.categoria_video.altera_categoria(this.email, this.id, change);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new AlterarCategoriaVideoUI().setVisible(true);
